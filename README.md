...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/francislagares/github-finder/Tests?style=for-the-badge&labelColor=black&logo=github)
...
- Clone the repo
  ...
  ```bash
  $ git clone https://github.com/francislagares/github-finder.git
  ```
